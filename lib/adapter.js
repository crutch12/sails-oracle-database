...
module.exports = (function() {
    ...
    var adapter = {
        ...
        // query: function(connectionName, table, query, data, cb, commit) {
            ...
            connectionObject.pool.getConnection(
                function(err, connection) {
                    ...
                    connection.execute(query, data, { outFormat: oracledb.OBJECT }, function(err, result) {
                        ...
                        if (commit == false) {
                            console.log('query WITHOUT COMMIT');
        ...
        describe: function(connectionName, table, cb) {
            ...
            queries[2] = "SELECT cols.table_name, cols.column_name, cols.position, cons.status, cons.owner " + "FROM all_constraints cons, all_cons_columns cols WHERE cols.table_name = '" + table + "' AND cons.constraint_type = 'P' AND cons.constraint_name = cols.constraint_name AND cons.owner = cols.owner " + "ORDER BY cols.table_name, cols.position";
